    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-150">
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden">
          ...
          {/* Header */}
          <div className="bg-slate-900 dark:bg-slate-950 text-white px-4 sm:px-6 py-4 flex items-center justify-between border-b border-slate-800 flex-shrink-0">
            <div className="flex items-center space-x-3 truncate">
              <div className="w-10 h-10 bg-red-700 rounded-2xl flex items-center justify-center text-white font-black text-sm shadow-md flex-shrink-0">
                4ª
              </div>
              <div className="truncate">
                <div className="flex items-center space-x-2">
                  <span className="bg-red-700/80 text-amber-300 text-[10px] font-black px-2.5 py-0.5 rounded-full border border-red-600/50 uppercase">
                  ...
                  <span className={`text-[10px] font-black px-2 py-0.5 rounded-full border ${
                    ...
                    {report.status === 'APROBADO' ? '✓ PARTE APROBADO & FIRMADO' : '⏳ PENDIENTE DE REVISIÓN'}
                  </span>
                </div>
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              <button
                ...
                className="bg-amber-600 hover:bg-amber-700 text-white font-black text-xs px-3 py-2 rounded-xl flex items-center space-x-1.5 transition active:scale-95 shadow-sm"
                title="Firmar Digitalmente"
              >
                <PenTool className="w-3.5 h-3.5" />
                <span className="hidden sm:inline">Firmar Digitalmente</span>
              </button>

              <button
                onClick={handleDownloadPDF}
                className="bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs px-3 py-2 rounded-xl flex items-center space-x-1.5 transition active:scale-95 border border-slate-700"
          ...
          {/* Modal Body */}
          <div className="p-4 sm:p-6 overflow-y-auto space-y-6 text-xs text-slate-800 dark:text-slate-200">
